...
public class MasterDetailPageRenderer extends DrawerLayout implements IGCUserPeer, DrawerListener {
    ...
    public MasterDetailPageRenderer(Context context, AttributeSet attributeSet, int i) throws Throwable {
    ...
    public MasterDetailPageRenderer(Context context, AttributeSet attributeSet) throws Throwable {
    ...
    public MasterDetailPageRenderer(Context context) throws Throwable {
        super(context);
        if (getClass() == MasterDetailPageRenderer.class) {
