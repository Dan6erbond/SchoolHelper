...
class ToolbarActionBar extends ActionBar {
    ...
    private final OnMenuItemClickListener mMenuClicker = new C02542();
    private final Runnable mMenuInvalidator = new C02531();
    ...
    class C02542 implements OnMenuItemClickListener {
        C02542() {
        }
...
*/
    ...
    private void ensureListMenuPresenter(Menu menu) {
        if (this.mListMenuPresenter == null && (menu instanceof MenuBuilder)) {
            ...
            this.mListMenuPresenter = new ListMenuPresenter(context2, C0259R.layout.abc_list_menu_item_layout);
