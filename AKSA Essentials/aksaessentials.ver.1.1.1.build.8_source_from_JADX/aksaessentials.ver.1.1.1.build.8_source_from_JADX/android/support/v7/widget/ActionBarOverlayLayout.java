...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = new int[]{C0259R.attr.actionBarSize, 16842841};
    ...
    class C02921 extends ViewPropertyAnimatorListenerAdapter {
        C02921() {
        }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C02921();
        this.mRemoveActionBarHideOffset = new C02932();
        this.mAddActionBarHideOffset = new C02943();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0259R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0259R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0259R.id.action_bar));
        }
    }
