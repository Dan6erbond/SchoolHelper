...
public class StaggeredGridLayoutManager extends LayoutManager {
    ...
    private final Runnable mCheckForGapsRunnable = new C03481();
    ...
    static class LazySpanLookup {
        ...
        static class FullSpanItem implements Parcelable {
            public static final Creator<FullSpanItem> CREATOR = new C03501();
            int mGapDir;
            int[] mGapPerSpan;
    ...
    public static class SavedState implements Parcelable {
        public static final Creator<SavedState> CREATOR = new C03511();
