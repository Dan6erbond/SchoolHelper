...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    private class DropdownPopup extends ListPopupWindow {
        ...
        public void show() {
            ...
            if (!wasShowing) {
                ...
                if (vto != null) {
                    final OnGlobalLayoutListener layoutListener = new C03082();
    ...
    public AppCompatSpinner(Context context, int mode) {
        this(context, null, C0259R.attr.spinnerStyle, mode);
    }

    public AppCompatSpinner(Context context, AttributeSet attrs) {
        this(context, attrs, C0259R.attr.spinnerStyle);
    }
    ...
    public AppCompatSpinner(Context context, AttributeSet attrs, int defStyleAttr, int mode, Theme popupTheme) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0259R.styleable.Spinner, defStyleAttr, 0);
        ...
        if (popupTheme != null) {
            ...
            int popupThemeResId = a.getResourceId(C0259R.styleable.Spinner_popupTheme, 0);
        ...
        if (this.mPopupContext != null) {
            ...
            if (mode == 1) {
                ...
                TintTypedArray pa = TintTypedArray.obtainStyledAttributes(this.mPopupContext, attrs, C0259R.styleable.Spinner, defStyleAttr, 0);
                this.mDropDownWidth = pa.getLayoutDimension(C0259R.styleable.Spinner_android_dropDownWidth, -2);
                popup.setBackgroundDrawable(pa.getDrawable(C0259R.styleable.Spinner_android_popupBackground));
                popup.setPromptText(a.getString(C0259R.styleable.Spinner_android_prompt));
                pa.recycle();
                this.mPopup = popup;
        ...
        CharSequence[] entries = a.getTextArray(C0259R.styleable.Spinner_android_entries);
        if (entries != null) {
            SpinnerAdapter adapter = new ArrayAdapter(context, C0259R.layout.support_simple_spinner_dropdown_item, entries);
            adapter.setDropDownViewResource(C0259R.layout.support_simple_spinner_dropdown_item);
            setAdapter(adapter);
        }
        a.recycle();
        this.mPopupSet = true;
