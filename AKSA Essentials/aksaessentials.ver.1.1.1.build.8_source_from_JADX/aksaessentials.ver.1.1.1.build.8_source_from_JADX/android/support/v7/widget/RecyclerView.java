...
import android.support.v7.recyclerview.C0281R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    private static final Interpolator sQuinticInterpolator = new C03303();
    ...
    public static abstract class LayoutManager {
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0281R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0281R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0281R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0281R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0281R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
    ...
    static class C03303 implements Interpolator {
        C03303() {
        }
    ...
    class C03314 implements ProcessCallback {
        C03314() {
        }
    ...
    class C03325 implements Callback {
        C03325() {
        }
    ...
    class C03336 implements Callback {
        C03336() {
        }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        this.mUpdateChildViewsRunnable = new C03281();
        ...
        this.mItemAnimatorRunner = new C03292();
        this.mViewInfoProcessCallback = new C03314();
        ...
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, C0281R.styleable.RecyclerView, defStyle, 0);
            String layoutManagerName = a.getString(C0281R.styleable.RecyclerView_layoutManager);
            a.recycle();
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C03325());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C03336());
    }
