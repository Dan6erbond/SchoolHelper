...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C03382 implements Runnable {
        C03382() {
        }
    ...
    class C03404 implements OnFocusChangeListener {
        C03404() {
        }
    ...
    class C03415 implements OnLayoutChangeListener {
        C03415() {
        }
    ...
    class C03426 implements OnGlobalLayoutListener {
        C03426() {
        }
    ...
    class C03437 implements OnClickListener {
        C03437() {
        }
    ...
    class C03448 implements OnKeyListener {
        C03448() {
        }
    ...
    class C03459 implements OnEditorActionListener {
        C03459() {
        }
    ...
    static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = new C03461();
        boolean isIconified;

        static class C03461 implements Creator<SavedState> {
            C03461() {
            }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attrs) {
            this(context, attrs, C0259R.attr.autoCompleteTextViewStyle);
        }
    ...
    public SearchView(Context context, AttributeSet attrs) {
        this(context, attrs, C0259R.attr.searchViewStyle);
    }

    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.mShowImeRunnable = new C03371();
        this.mUpdateDrawableStateRunnable = new C03382();
        this.mReleaseCursorRunnable = new C03393();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C03437();
        this.mTextKeyListener = new C03448();
        this.mOnEditorActionListener = new C03459();
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0259R.styleable.SearchView, defStyleAttr, 0);
        LayoutInflater.from(context).inflate(a.getResourceId(C0259R.styleable.SearchView_layout, C0259R.layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0259R.id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0259R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0259R.id.search_plate);
        this.mSubmitArea = findViewById(C0259R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0259R.id.search_button);
        this.mGoButton = (ImageView) findViewById(C0259R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0259R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0259R.id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0259R.id.search_mag_icon);
        this.mSearchPlate.setBackgroundDrawable(a.getDrawable(C0259R.styleable.SearchView_queryBackground));
        this.mSubmitArea.setBackgroundDrawable(a.getDrawable(C0259R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(a.getDrawable(C0259R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(a.getDrawable(C0259R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(a.getDrawable(C0259R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(a.getDrawable(C0259R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(a.getDrawable(C0259R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = a.getDrawable(C0259R.styleable.SearchView_searchHintIcon);
        this.mSuggestionRowLayout = a.getResourceId(C0259R.styleable.SearchView_suggestionRowLayout, C0259R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = a.getResourceId(C0259R.styleable.SearchView_commitIcon, 0);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C03404());
        setIconifiedByDefault(a.getBoolean(C0259R.styleable.SearchView_iconifiedByDefault, true));
        int maxWidth = a.getDimensionPixelSize(C0259R.styleable.SearchView_android_maxWidth, -1);
        if (maxWidth != -1) {
            setMaxWidth(maxWidth);
        }
        this.mDefaultQueryHint = a.getText(C0259R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = a.getText(C0259R.styleable.SearchView_queryHint);
        int imeOptions = a.getInt(C0259R.styleable.SearchView_android_imeOptions, -1);
        if (imeOptions != -1) {
            setImeOptions(imeOptions);
        }
        int inputType = a.getInt(C0259R.styleable.SearchView_android_inputType, -1);
        if (inputType != -1) {
            setInputType(inputType);
        }
        setFocusable(a.getBoolean(C0259R.styleable.SearchView_android_focusable, true));
        a.recycle();
    ...
    private void addOnLayoutChangeListenerToDropDownAnchorSDK11() {
        this.mDropDownAnchor.addOnLayoutChangeListener(new C03415());
    }

    private void addOnLayoutChangeListenerToDropDownAnchorBase() {
        this.mDropDownAnchor.getViewTreeObserver().addOnGlobalLayoutListener(new C03426());
    }
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0259R.dimen.abc_search_view_preferred_width);
    }
    ...
    private void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int iconOffset = this.mIconifiedByDefault ? res.getDimensionPixelSize(C0259R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C0259R.dimen.abc_dropdownitem_text_padding_left) : 0;
