...
public class ScrimInsetsFrameLayout extends FrameLayout {
    ...
    class C00031 implements OnApplyWindowInsetsListener {
        C00031() {
        }
    ...
    public ScrimInsetsFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mInsetForeground = a.getDrawable(C0000R.styleable.ScrimInsetsFrameLayout_insetForeground);
        a.recycle();
        setWillNotDraw(true);
        ViewCompat.setOnApplyWindowInsetsListener(this, new C00031());
    }
