...
public class ParcelableSparseArray extends SparseArray<Parcelable> implements Parcelable {
    public static final Creator<ParcelableSparseArray> CREATOR = ParcelableCompat.newCreator(new C00021());

    static class C00021 implements ParcelableCompatCreatorCallbacks<ParcelableSparseArray> {
        C00021() {
        }
