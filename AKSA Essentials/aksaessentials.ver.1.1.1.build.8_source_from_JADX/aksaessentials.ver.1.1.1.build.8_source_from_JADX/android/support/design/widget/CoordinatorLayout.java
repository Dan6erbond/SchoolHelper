...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent {
    ...
    class C00131 implements Comparator<View> {
        C00131() {
        }
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        LayoutParams(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray a = context.obtainStyledAttributes(attrs, C0000R.styleable.CoordinatorLayout_LayoutParams);
            this.gravity = a.getInteger(C0000R.styleable.CoordinatorLayout_LayoutParams_android_layout_gravity, 0);
            this.mAnchorId = a.getResourceId(C0000R.styleable.CoordinatorLayout_LayoutParams_layout_anchor, -1);
            this.anchorGravity = a.getInteger(C0000R.styleable.CoordinatorLayout_LayoutParams_layout_anchorGravity, 0);
            this.keyline = a.getInteger(C0000R.styleable.CoordinatorLayout_LayoutParams_layout_keyline, -1);
            this.mBehaviorResolved = a.hasValue(C0000R.styleable.CoordinatorLayout_LayoutParams_layout_behavior);
            if (this.mBehaviorResolved) {
                this.mBehavior = CoordinatorLayout.parseBehavior(context, attrs, a.getString(C0000R.styleable.CoordinatorLayout_LayoutParams_layout_behavior));
            }
            a.recycle();
        }
    ...
    protected static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C00141());
        SparseArray<Parcelable> behaviorStates;

        static class C00141 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C00141() {
            }
    ...
    public CoordinatorLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mLayoutDependencyComparator = new C00131();
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0000R.styleable.CoordinatorLayout, defStyleAttr, C0000R.style.Widget_Design_CoordinatorLayout);
        int keylineArrayRes = a.getResourceId(C0000R.styleable.CoordinatorLayout_keylines, 0);
        ...
        this.mStatusBarBackground = a.getDrawable(C0000R.styleable.CoordinatorLayout_statusBarBackground);
        a.recycle();
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(ViewCompat.resolveSizeAndState(widthUsed, widthMeasureSpec, ViewCompat.MEASURED_STATE_MASK & childState), ViewCompat.resolveSizeAndState(heightUsed, heightMeasureSpec, childState << 16));
    }
