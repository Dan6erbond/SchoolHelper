...
public class TextInputLayout extends LinearLayout {
    ...
    class C00401 implements TextWatcher {
        C00401() {
        }
    ...
    class C00412 extends ViewPropertyAnimatorListenerAdapter {
        C00412() {
        }
    ...
    class C00434 implements AnimatorUpdateListener {
        C00434() {
        }
    ...
    static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = new C00441();
        CharSequence error;

        static class C00441 implements Creator<SavedState> {
            C00441() {
            }
    ...
    public TextInputLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setCounterMaxLength(a.getInt(C0000R.styleable.TextInputLayout_counterMaxLength, -1));
    ...
    private void setEditText(EditText editText) {
        ...
        this.mEditText.addTextChangedListener(new C00401());
        ...
        if (this.mErrorEnabled != enabled) {
            ...
            if (enabled) {
                ...
                try {
                    ...
                    this.mErrorView.setTextAppearance(getContext(), C0000R.style.TextAppearance_AppCompat_Caption);
        ...
        if (!TextUtils.equals(this.mError, error)) {
            ...
            if (this.mErrorShown) {
                ...
                if (animate) {
                    ...
                    ViewCompat.animate(this.mErrorView).alpha(1.0f).setDuration(200).setInterpolator(AnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR).setListener(new C00412()).start();
                }
        ...
        if (this.mCounterEnabled != enabled) {
            if (enabled) {
                ...
                try {
                    ...
                    this.mCounterView.setTextAppearance(getContext(), C0000R.style.TextAppearance_AppCompat_Caption);
    ...
    private void animateToExpansionFraction(float target) {
        if (this.mCollapsingTextHelper.getExpansionFraction() != target) {
            if (this.mAnimator == null) {
                ...
                this.mAnimator.setUpdateListener(new C00434());
            }
