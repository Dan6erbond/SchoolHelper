...
public class TabLayout extends HorizontalScrollView {
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mTabStrip.setSelectedIndicatorHeight(a.getDimensionPixelSize(C0000R.styleable.TabLayout_tabIndicatorHeight, 0));
        this.mTabStrip.setSelectedIndicatorColor(a.getColor(C0000R.styleable.TabLayout_tabIndicatorColor, 0));
        int dimensionPixelSize = a.getDimensionPixelSize(C0000R.styleable.TabLayout_tabPadding, 0);
        ...
        try {
            this.mTabTextSize = (float) ta.getDimensionPixelSize(C0000R.styleable.TextAppearance_android_textSize, 0);
            ...
            if (a.hasValue(C0000R.styleable.TabLayout_tabSelectedTextColor)) {
                this.mTabTextColors = createColorStateList(this.mTabTextColors.getDefaultColor(), a.getColor(C0000R.styleable.TabLayout_tabSelectedTextColor, 0));
            }
            this.mRequestedTabMinWidth = a.getDimensionPixelSize(C0000R.styleable.TabLayout_tabMinWidth, -1);
            this.mRequestedTabMaxWidth = a.getDimensionPixelSize(C0000R.styleable.TabLayout_tabMaxWidth, -1);
            this.mTabBackgroundResId = a.getResourceId(C0000R.styleable.TabLayout_tabBackground, 0);
            this.mContentInsetStart = a.getDimensionPixelSize(C0000R.styleable.TabLayout_tabContentStart, 0);
            this.mMode = a.getInt(C0000R.styleable.TabLayout_tabMode, 1);
            this.mTabGravity = a.getInt(C0000R.styleable.TabLayout_tabGravity, 0);
            a.recycle();
            Resources res = getResources();
