...
public class AppBarLayout extends LinearLayout {
    ...
    class C00041 implements OnApplyWindowInsetsListener {
        C00041() {
        }
    ...
    public static class Behavior extends HeaderBehavior<AppBarLayout> {
        ...
        protected static class SavedState extends BaseSavedState {
            public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C00061());
            boolean firstVisibileChildAtMinimumHeight;
            float firstVisibileChildPercentageShown;
            int firstVisibleChildIndex;

            static class C00061 implements ParcelableCompatCreatorCallbacks<SavedState> {
                C00061() {
                }
    ...
    public static class LayoutParams extends android.widget.LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            super(c, attrs);
            TypedArray a = c.obtainStyledAttributes(attrs, C0000R.styleable.AppBarLayout_LayoutParams);
            this.mScrollFlags = a.getInt(C0000R.styleable.AppBarLayout_LayoutParams_layout_scrollFlags, 0);
            if (a.hasValue(C0000R.styleable.AppBarLayout_LayoutParams_layout_scrollInterpolator)) {
                this.mScrollInterpolator = AnimationUtils.loadInterpolator(c, a.getResourceId(C0000R.styleable.AppBarLayout_LayoutParams_layout_scrollInterpolator, 0));
            }
            a.recycle();
        }
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        public ScrollingViewBehavior(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray a = context.obtainStyledAttributes(attrs, C0000R.styleable.ScrollingViewBehavior_Params);
            setOverlayTop(a.getDimensionPixelSize(C0000R.styleable.ScrollingViewBehavior_Params_behavior_overlapTop, 0));
            a.recycle();
        }
    ...
    public AppBarLayout(Context context, AttributeSet attrs) {
        ...
        this.mTargetElevation = (float) a.getDimensionPixelSize(C0000R.styleable.AppBarLayout_elevation, 0);
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C00041());
    }
