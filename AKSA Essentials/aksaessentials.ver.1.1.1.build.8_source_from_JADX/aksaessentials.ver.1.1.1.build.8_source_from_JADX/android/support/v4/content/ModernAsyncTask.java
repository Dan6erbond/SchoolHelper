...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C00931();
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C00942();

    static class C00931 implements ThreadFactory {
    ...
    class C00942 extends WorkerRunnable<Params, Result> {
        C00942() {
            super();
        }
