...
class TransportMediatorJellybeanMR2 {
    OnAudioFocusChangeListener mAudioFocusChangeListener = new C01314();
    boolean mAudioFocused;
    final AudioManager mAudioManager;
    final Context mContext;
    boolean mFocused;
    final OnGetPlaybackPositionListener mGetPlaybackPositionListener = new C01325();
    final Intent mIntent;
    final BroadcastReceiver mMediaButtonReceiver = new C01303();
    PendingIntent mPendingIntent;
    int mPlayState = 0;
    final OnPlaybackPositionUpdateListener mPlaybackPositionUpdateListener = new C01336();
    final String mReceiverAction;
    final IntentFilter mReceiverFilter;
    RemoteControlClient mRemoteControl;
    final View mTargetView;
    final TransportMediatorCallback mTransportCallback;
    final OnWindowAttachListener mWindowAttachListener = new C01281();
    final OnWindowFocusChangeListener mWindowFocusListener = new C01292();

    class C01281 implements OnWindowAttachListener {
        C01281() {
        }
    ...
    class C01292 implements OnWindowFocusChangeListener {
        C01292() {
        }
    ...
    class C01314 implements OnAudioFocusChangeListener {
        C01314() {
        }
    ...
    class C01325 implements OnGetPlaybackPositionListener {
        C01325() {
        }
    ...
    class C01336 implements OnPlaybackPositionUpdateListener {
        C01336() {
        }
