...
public class MediaSessionCompat {
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        private android.support.v4.media.VolumeProviderCompat.Callback mVolumeCallback = new C01381();
        private VolumeProviderCompat mVolumeProvider;
        private int mVolumeType;

        class C01381 extends android.support.v4.media.VolumeProviderCompat.Callback {
            C01381() {
            }
        ...
        class C01392 implements Callback {
            C01392() {
            }
            ...
            private void onMediaButtonEvent(KeyEvent ke, Callback cb) {
                ...
                if (ke != null && ke.getAction() == 0) {
                    ...
                    switch (ke.getKeyCode()) {
                        case C0367R.styleable.AppCompatTheme_panelMenuListWidth /*79*/:
                        case C0367R.styleable.AppCompatTheme_colorControlNormal /*85*/:
                            boolean isPlaying;
                        ...
                        case C0367R.styleable.AppCompatTheme_colorControlActivated /*86*/:
                            if ((1 & validActions) != 0) {
                                cb.onStop();
                                return;
                            }
                            return;
                        case C0367R.styleable.AppCompatTheme_colorControlHighlight /*87*/:
                            if ((32 & validActions) != 0) {
                                cb.onSkipToNext();
                                return;
                            }
                            return;
                        case C0367R.styleable.AppCompatTheme_colorButtonNormal /*88*/:
                            if ((16 & validActions) != 0) {
                                cb.onSkipToPrevious();
                                return;
                            }
                            return;
                        case C0367R.styleable.AppCompatTheme_colorSwitchThumbNormal /*89*/:
                            if ((8 & validActions) != 0) {
                                cb.onRewind();
                                return;
                            }
                            return;
                        case C0367R.styleable.AppCompatTheme_controlBackground /*90*/:
    ...
    public static final class QueueItem implements Parcelable {
        public static final Creator<QueueItem> CREATOR = new C01401();
        public static final int UNKNOWN_ID = -1;
        private final MediaDescriptionCompat mDescription;
        private final long mId;
        private Object mItem;

        static class C01401 implements Creator<QueueItem> {
            C01401() {
            }
    ...
    static final class ResultReceiverWrapper implements Parcelable {
        public static final Creator<ResultReceiverWrapper> CREATOR = new C01411();
        private ResultReceiver mResultReceiver;

        static class C01411 implements Creator<ResultReceiverWrapper> {
            C01411() {
            }
    ...
    public static final class Token implements Parcelable {
        public static final Creator<Token> CREATOR = new C01421();
        private final Object mInner;

        static class C01421 implements Creator<Token> {
            C01421() {
            }
