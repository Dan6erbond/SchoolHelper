...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C01721();
    ...
    private static final Interpolator sInterpolator = new C01732();
    ...
    private final Runnable mEndScrollRunnable = new C01743();
    ...
    static class C01721 implements Comparator<ItemInfo> {
        C01721() {
        }
    ...
    static class C01732 implements Interpolator {
        C01732() {
        }
    ...
    class C01754 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    public static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C01761());
        Parcelable adapterState;
        ClassLoader loader;
        int position;

        static class C01761 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C01761() {
            }
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C01754());
    }
        ...
        switch (ev.getAction() & 255) {
            ...
            case 1:
                if (this.mIsBeingDragged) {
                    ...
                    ItemInfo ii = infoForCurrentScrollPosition();
                    float marginOffset = ((float) this.mPageMargin) / ((float) width);
                    setCurrentItemInternal(determineTargetPage(ii.position, ((((float) scrollX) / ((float) width)) - ii.offset) / (ii.widthFactor + marginOffset), initialVelocity, (int) (MotionEventCompat.getX(ev, MotionEventCompat.findPointerIndex(ev, this.mActivePointerId)) - this.mInitialMotionX)), true, true, initialVelocity);
    ...
    public boolean executeKeyEvent(KeyEvent event) {
        ...
        switch (event.getKeyCode()) {
            ...
            case C0367R.styleable.AppCompatTheme_popupWindowStyle /*61*/:
                if (VERSION.SDK_INT < 11) {
                    return false;
                }
