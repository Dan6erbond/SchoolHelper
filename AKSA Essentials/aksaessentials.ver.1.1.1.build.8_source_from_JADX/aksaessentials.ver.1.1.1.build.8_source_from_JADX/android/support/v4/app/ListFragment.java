...
public class ListFragment extends Fragment {
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = new C00862();
    View mProgressContainer;
    private final Runnable mRequestFocus = new C00851();
    ...
    class C00862 implements OnItemClickListener {
        C00862() {
        }
