...
public class PageContainer extends ViewGroup implements IGCUserPeer {
    ...
    public PageContainer(Context context) throws Throwable {
        super(context);
    ...
    public PageContainer(Context context, AttributeSet attributeSet) throws Throwable {
    ...
    public PageContainer(Context context, AttributeSet attributeSet, int i) throws Throwable {
