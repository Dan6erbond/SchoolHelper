...
public class ProgressBarRenderer extends ViewRenderer_2 implements IGCUserPeer {
    ...
    public ProgressBarRenderer(Context context) throws Throwable {
        super(context);
        if (getClass() == ProgressBarRenderer.class) {
            TypeManager.Activate("Xamarin.Forms.Platform.Android.ProgressBarRenderer, Xamarin.Forms.Platform.Android, Version=2.0.0.0, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new Object[]{context});
        }
    }
