...
public class TableViewRenderer extends ViewRenderer_2 implements IGCUserPeer {
    ...
    public TableViewRenderer(Context context, AttributeSet attributeSet, int i) throws Throwable {
    ...
    public TableViewRenderer(Context context, AttributeSet attributeSet) throws Throwable {
    ...
    public TableViewRenderer(Context context) throws Throwable {
        super(context);
        if (getClass() == TableViewRenderer.class) {
