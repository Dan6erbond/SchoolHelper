...
public class SwitchRenderer extends ViewRenderer_2 implements IGCUserPeer, OnCheckedChangeListener {
    ...
    static {
        Runtime.register("Xamarin.Forms.Platform.Android.SwitchRenderer, Xamarin.Forms.Platform.Android, Version=2.0.0.0, Culture=neutral, PublicKeyToken=null", SwitchRenderer.class, __md_methods);
    }
    ...
    public SwitchRenderer(Context context) throws Throwable {
        super(context);
        if (getClass() == SwitchRenderer.class) {
            TypeManager.Activate("Xamarin.Forms.Platform.Android.SwitchRenderer, Xamarin.Forms.Platform.Android, Version=2.0.0.0, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new Object[]{context});
        }
    }
