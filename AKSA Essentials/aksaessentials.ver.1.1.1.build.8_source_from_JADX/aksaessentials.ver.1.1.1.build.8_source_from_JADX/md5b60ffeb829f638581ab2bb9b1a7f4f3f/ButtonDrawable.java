...
public class ButtonDrawable extends Drawable implements IGCUserPeer {
    ...
    static {
        Runtime.register("Xamarin.Forms.Platform.Android.ButtonDrawable, Xamarin.Forms.Platform.Android, Version=2.0.0.0, Culture=neutral, PublicKeyToken=null", ButtonDrawable.class, __md_methods);
    }

    public ButtonDrawable() throws Throwable {
        if (getClass() == ButtonDrawable.class) {
            TypeManager.Activate("Xamarin.Forms.Platform.Android.ButtonDrawable, Xamarin.Forms.Platform.Android, Version=2.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new Object[0]);
        }
    }
