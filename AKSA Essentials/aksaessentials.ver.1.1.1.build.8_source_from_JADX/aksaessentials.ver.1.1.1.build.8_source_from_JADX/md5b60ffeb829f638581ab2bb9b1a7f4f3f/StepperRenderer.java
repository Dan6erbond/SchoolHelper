...
public class StepperRenderer extends ViewRenderer_2 implements IGCUserPeer {
    ...
    public StepperRenderer(Context context, AttributeSet attributeSet, int i) throws Throwable {
    ...
    public StepperRenderer(Context context, AttributeSet attributeSet) throws Throwable {
    ...
    public StepperRenderer(Context context) throws Throwable {
        super(context);
        if (getClass() == StepperRenderer.class) {
