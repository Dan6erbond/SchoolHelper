...
public class ListViewRenderer extends ViewRenderer_2 implements IGCUserPeer, OnRefreshListener {
    ...
    public ListViewRenderer(Context context, AttributeSet attributeSet, int i) throws Throwable {
    ...
    public ListViewRenderer(Context context, AttributeSet attributeSet) throws Throwable {
    ...
    public ListViewRenderer(Context context) throws Throwable {
        super(context);
        if (getClass() == ListViewRenderer.class) {
