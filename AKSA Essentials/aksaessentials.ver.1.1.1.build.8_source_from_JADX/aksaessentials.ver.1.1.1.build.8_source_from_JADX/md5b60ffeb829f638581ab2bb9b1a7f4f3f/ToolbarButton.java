...
public class ToolbarButton extends Button implements IGCUserPeer {
    ...
    public ToolbarButton(Context context) throws Throwable {
        super(context);
    ...
    public ToolbarButton(Context context, AttributeSet attributeSet) throws Throwable {
    ...
    public ToolbarButton(Context context, AttributeSet attributeSet, int i) throws Throwable {
