...
public class FormsAppCompatActivity extends AppCompatActivity implements IGCUserPeer {
    ...
    static {
        Runtime.register("Xamarin.Forms.Platform.Android.FormsAppCompatActivity, Xamarin.Forms.Platform.Android, Version=2.0.0.0, Culture=neutral, PublicKeyToken=null", FormsAppCompatActivity.class, __md_methods);
    }

    public FormsAppCompatActivity() throws Throwable {
        if (getClass() == FormsAppCompatActivity.class) {
            TypeManager.Activate("Xamarin.Forms.Platform.Android.FormsAppCompatActivity, Xamarin.Forms.Platform.Android, Version=2.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new Object[0]);
        }
    }
