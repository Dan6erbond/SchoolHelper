...
public class PickerRenderer_PickerListener implements IGCUserPeer, OnClickListener {
    ...
    static {
        Runtime.register("Xamarin.Forms.Platform.Android.PickerRenderer+PickerListener, Xamarin.Forms.Platform.Android, Version=2.0.0.0, Culture=neutral, PublicKeyToken=null", PickerRenderer_PickerListener.class, __md_methods);
    }

    public PickerRenderer_PickerListener() throws Throwable {
        if (getClass() == PickerRenderer_PickerListener.class) {
            TypeManager.Activate("Xamarin.Forms.Platform.Android.PickerRenderer+PickerListener, Xamarin.Forms.Platform.Android, Version=2.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new Object[0]);
        }
    }
