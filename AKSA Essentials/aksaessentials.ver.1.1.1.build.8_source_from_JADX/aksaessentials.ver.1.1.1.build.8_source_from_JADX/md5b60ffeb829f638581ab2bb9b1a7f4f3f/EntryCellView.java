...
public class EntryCellView extends LinearLayout implements IGCUserPeer, TextWatcher, NoCopySpan, OnFocusChangeListener, OnEditorActionListener {
    ...
    public EntryCellView(Context context) throws Throwable {
        super(context);
    ...
    public EntryCellView(Context context, AttributeSet attributeSet) throws Throwable {
    ...
    public EntryCellView(Context context, AttributeSet attributeSet, int i) throws Throwable {
