...
public class FragmentBreadCrumbs_OnBreadCrumbClickListenerImplementor implements IGCUserPeer, OnBreadCrumbClickListener {
    ...
    private native boolean n_onBreadCrumbClick(BackStackEntry backStackEntry, int i);
    ...
    public boolean onBreadCrumbClick(BackStackEntry backStackEntry, int i) {
